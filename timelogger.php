	 ...
	 <div class="container">
        <div class="row">
            <div class="col-md-7 col-md-offset-3" >
                <div class="login-panel panel panel-default" style="height:300px ; background-color:#2DDA81; ">
                    <div class="panel-heading"style=" background-color:#4A9AEB;">
                        <h3 class="panel-title" ><b style="color:#FFF; font-size:25px;"><center>Attendance Login Activation</center></b></h3>
                    </div>
                    <div class="panel-body">
                        <form action="log_query_attendance.php" method="post">
                            <fieldset>
						<?php	
...
?>
            <h4></h4>			<center>
                                <div class="form-group">
									...
									<input type="text" name="user" class="form-control input-lg "  style="height:50px; font-size:25px;" placeholder="Username" autocomplete="off" required autofocus/>           
                                </div>
								</center>
								<center>
                                <div class="form-group">
									
									<input type="password" name="pass" class="form-control input-lg "  style="height:50px; font-size:25px;" placeholder="Password"  />           
                                </div>
								</center>
