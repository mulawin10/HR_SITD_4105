  ...
  <body>
    ...
    <div class="blog-masthead ">
      <div class="container">
        <nav class="blog-nav">
          ...
          <a class="blog-nav-item active" href="#">Contact</a>
    ...
    <div class="container" >
      ...
      <div class="blog-header">
        <h1 class="blog-title" style="font-size:30px; ">
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title">Victorias National High School Aniversary</h2>
            <p class="blog-post-meta">January 1, 2014 <a href="#"></a></p>
