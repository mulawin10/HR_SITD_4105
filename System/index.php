...
<html lang="en">
  ...
  <body>
	 ...
	 <img src="image/112.jpg" height="150px;" width="150p;" style="border-radius:100px;position:relative; top:-10px; right:-100px; ">
	 </div> 
	  		<h1><strong style="position:relative; top:5px;">CALVIN</strong></br><strong style="position:relative; top:20px;">HUMAN RESOURCE INTEGRATED SYSTEM</strong><h1>
     </div>
