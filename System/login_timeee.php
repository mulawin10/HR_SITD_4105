 ...
 <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 col-md-offset-3" >
                <div class="login-panel panel panel-default" style=" min-height:250px ; background-color:#2DDA81; ">
                    <div class="panel-heading" style=" background-color:#4A9AEB;">
                        <h3 class="panel-title" ><b><center>TIME LOG</center></b></h3>
                    </div>
					<form>
							<div style="color:black; font-family:arial; border:solid #2DDA81 10px; background-color:white; border-radius:10px;">
						<?php
						$emp_id=$_GET['emp_id'];
					$emp=(" select * from personal_information where employee_id=".$emp_id."") or die(mysql_error());
										...
										<?PHP IF($show['image']!=NULL)
										{
												ECHO "<img src='admin_route/upload/$image' height='150px' width='150px'  >";
													echo	"<div style='border:solid white 0px; float:right; width:330px; '>";
													}
													else
													{
													ECHO "<img src='admin_route/upload/download (1).jpg' height='150px' width='150px'  >";
													echo	"<div style='border:solid white 0px; float:right; width:330px; '>";
													}
													?>
            ...
            <h4></h4>			<center>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" name="date" type="hidden" value="<?php echo date("M d, Y "); ?>">
                                </div>
